    ...
    <div className="min-h-screen bg-[#1E1E1E] text-white p-8 font-light">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="bg-[#252525] rounded-lg px-10 pb-10">
          {/* Stats Title */}
          <h2 className="text-2xl font-bold pt-8 mb-8">
            ...
            <thead>
              <tr>
                ...
                <th className="text-center pb-8 w-1/3">
                  <div className="bg-[#303030] rounded px-4 py-6 text-xl font-light">
                    Total calls
                  </div>
                </th>
                <th className="text-center pb-8 w-1/3">
            ...
            <tbody className="text-3xl tracking-wide">
              <tr>
                <td className="relative w-12">
                  <div
                    className="absolute -left-2 top-1/2 -translate-y-1/2 text-white/80 text-lg -rotate-180"
            ...
            <div className="relative h-[98%] ml-8">
              ...
              <div className="absolute bottom-[-60px] left-0 right-5">
                ...
                <div className="relative float-left w-[70px]">
                  ...
                  <span className="absolute w-full text-center text-xs text-gray-400 mt-2">
                    Week past
                  </span>
                </div>
                ...
                >
                  ...
                  <span className="absolute left-1/2 -translate-x-1/2 text-xs text-gray-400 mt-2">
                    Future weeks
                  </span>
                </div>
              </div>
        ...
        <div className="mt-16">
          ...
          <div className="grid grid-cols-2 gap-8">
            ...
            <div className="bg-[#252525] rounded-lg p-8">
              <h3 className="text-3xl font-light mb-6 text-[#4CAF50]">
                Highlights:
              </h3>
            ...
            {/* Opportunities */}
            <div className="bg-[#252525] rounded-lg p-8">
              <h3 className="text-3xl font-light mb-6 text-[#FF6B8A]">
                Opportunities:
              </h3>
              <ul className="space-y-4">
              ...
              (conv) => (
                <div key={conv.id} className="bg-[#2A2A2A] p-6 rounded">
                  ...
                  <div className="space-y-2 text-sm">
                    <p>
                      <span className="text-gray-400">Student Trigger:</span>{" "}
                      {conv.studentTrigger}
                    </p>
                    <p>
                      <span className="text-gray-400">Context & Impact:</span>{" "}
                      {conv.contextAndImpact}
                    </p>
                    <p>
